...
function LinksSection() {
  return (
    <main className="linkssection flex justify-between items-stretch max-lg:flex-col max-lg:h-fit">
      <ExpCard />
      <div className="links w-1/3 h-full flex flex-col max-lg:w-full max-md:mt-6">
        ...
        <div
          className="test flex mt-2 flex-wrap p-5 rounded-xl flex-grow items-center max-md:py-4 max-md:px-0 max-md:justify-evenly
