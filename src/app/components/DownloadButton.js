...
const Button = () => {
  return (
    <StyledWrapper>
      <a
        className="sp"
        href="https://drive.google.com/file/d/1pdZDsgwONU3R7gWPi-o9pWeBK_kgxbCV/view"
        target="_blank"
      >
...
const StyledWrapper = styled.div`
  .sparkle-button {
    ...
    box-shadow: 0 0 calc(var(--active) * 3em) calc(var(--active) * 1em)
        hsl(145 97% 61% / 0.75),
      0 0em 0 0
        hsl(145 calc(var(--active) * 97%) calc((var(--active) * 50%) + 30%))
        inset,
      0 -0.05em 0 0 hsl(145 calc(var(--active) * 97%) calc(var(--active) * 60%))
        inset;
  ...
  .text {
    ...
    background: linear-gradient(
      90deg,
      hsl(145 0% calc((var(--active) * 100%) + 65%)),
      hsl(145 0% calc((var(--active) * 100%) + 26%))
    );
