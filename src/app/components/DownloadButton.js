...
const Button = () => {
  return (
    <StyledWrapper>
      <a className="sp" href='https://drive.google.com/file/d/1pdZDsgwONU3R7gWPi-o9pWeBK_kgxbCV/view' target='_blank'>
...
const StyledWrapper = styled.div`
  .sparkle-button {
    ...
    --bg:radial-gradient(
        40% 50% at center 100%,
        hsl(140 calc(var(--active) * 80%) 35% / var(--active)),
        transparent
    ),
    radial-gradient(
        80% 100% at center 120%,
        hsl(130 calc(var(--active) * 80%) 33% / var(--active)),
        transparent
    ),
    hsl(145 calc(var(--active) * 80%) calc((var(--active) * 25%) + 18%));
    font-size: 1rem;
    font-weight: 500;
    border: 0;
    cursor: pointer;
    ...
    border-radius: 100px;
    position: relative;
    box-shadow: 0 0 calc(var(--active) * 3em) calc(var(--active) * 1em) hsl(145 97% 61% / 0.75),
  		0 0em 0 0 hsl(145 calc(var(--active) * 97%) calc((var(--active) * 50%) + 30%)) inset,
  		0 -0.05em 0 0 hsl(145 calc(var(--active) * 97%) calc(var(--active) * 60%)) inset;
  ...
  .sparkle-button:before {
    ...
    inset: -0.2em;
    z-index: -1;
    border: 0.15em solid hsl(145 97% 50% / 0.5);
    border-radius: 100px;
  ...
  .text {
    ...
    background: linear-gradient(90deg, hsl(145 0% calc((var(--active) * 100%) + 65%)), hsl(145 0% calc((var(--active) * 100%) + 26%)));
