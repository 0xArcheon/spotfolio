...
function IntroSection() {
  return (
    <main className="introsection h-60 flex gap-8 p-8 ">
      <div className="introtext p-8 border-2 border-fern-400 w-3/4 rounded-xl">
      ...
      <div className="photo border-2 border-fern-400 rounded-xl">
        <img
